...
public class ArrayEx {
    public static void main(String[] args) {
        ...
        System.out.println("intArray : " + intArray); // 참조값 저장 ([I@682a0b20)
        ...
        System.out.println("Copy : " + Arrays.toString(copiedArray)); // [1, 2, 3]

        // copyOfRange(arr, sIdx, eIdx)
        int[] rangeArray = Arrays.copyOfRange(originArray, 1, 3);
        System.out.println("Range : " + Arrays.toString(rangeArray)); // [2, 3]

        // fill(arr, n) : n 값으로 배열 채워서 초기화
        int[] filledArray = new int[5];
        System.out.println("Filled (before) : " + Arrays.toString(filledArray));
        Arrays.fill(filledArray, 7);
        System.out.println("Filled (after) : " + Arrays.toString(filledArray)); // [7, 7, 7, 7, 7]

        // sort(arr) : 정렬
        int[] unSortedArray = {5,3,1,4,2};
        Arrays.sort(unSortedArray);
        System.out.println("Sorted : " + Arrays.toString(unSortedArray)); // [1, 2, 3, 4, 5]
        ...
        System.out.println("== 비교 1 vs 2 : " + (array1 == array2)); // false
        System.out.println("== 비교 1 vs 3 : " + (array1 == array3)); // false
